...
function b18_theme_js() {
  ...
  wp_enqueue_script( 'bootstrap_js', get_template_directory_uri() . '/js/bootstrap.min.js', array('jquery', 'popper_js'), '', true );

  wp_enqueue_script( 'foundation_js', get_template_directory_uri() . '/js/holder.min.js', array('jquery', 'bootstrap_js'), '', true );
